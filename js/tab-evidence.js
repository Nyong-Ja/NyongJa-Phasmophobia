...
const GHOST_SIGNATURE_SKILLS = {
    ...
    "한투": "추운 방에서 2.7m/s 가속 & 사냥 중 냉기 입김",
    "하투": "추운 방에서 2.7m/s 가속 & 사냥 중 냉기 입김",
    "고료": "방 변경 불가 & 비디오 카메라로만 DOTS 관측",
    "마일링": "사냥 발소리가 전자기기 깜빡임(10m) 때만 들림",
    "밀링": "사냥 발소리가 전자기기 깜빡임(10m) 때만 들림",
    "원령": "불씨 3개 끄면 즉시 강제 사냥 (양초=십자가)",
    "온료": "불씨 3개 끄면 즉시 강제 사냥 (양초=십자가)",
